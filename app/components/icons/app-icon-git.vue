...
const variants = {
    original: { primary: '#DE4C36' },
    accent:   { primary: 'var(--accent-color-1)' },
    muted:    { primary: 'var(--bg-color-500)' },
}
