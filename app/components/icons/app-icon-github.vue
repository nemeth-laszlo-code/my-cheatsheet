...
const variants = {
    original: { primary: '#000000' },
    accent:   { primary: 'var(--accent-color-1)' },
    muted:    { primary: 'var(--text-color-1)' },
}
